...
class PolylineTool extends FabricCanvasTool {
  ...
  private completedEdit: boolean;
  private editing: boolean;
  private lines: fabric.Line[];
  private roof: fabric.Polygon;
  ...
  shouldEndPolygon(o) {
    ...
    return this.lines.some(line => {
      ...
      return distanceFromCursor < this._width;
    });
  }
  ...
  endPolygon(o) {
    ...
    const shape = new fabric.Polygon(this.roof.points, {
      ...obj,
      selectable: false,
      evented: false,
      fill: this._fill,
  ...
  //    */
  //   const poly = canvas.getObjects().find((canvasObject: fabric.Polygon) => {
